...
void handleLedOnTemporarily() {
  handleLedOn();
  delay(1000);// delay a moment, and switch turns off again
  handleLedOff();
}
...
const String HtmlButtons = 
    "<a href=\"LEDSwitch\"><button style=\"display: block; width: 100%;\">Switch</button></a><br/>"
...
void setup() {
    ...
    server.on("/LEDSwitch", handleLedOnTemporarily);
